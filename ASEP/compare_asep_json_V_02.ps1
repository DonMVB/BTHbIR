# ***************************************************************************
# *  Script      : compare_asep_json_V_02.ps1
# *  Version     : V_02
# *  Last Update : 2026-09-01 12:16 EST
...
# *    4. .\compare_asep_json_V_02.ps1 -Before BEFORE.json -After AFTER.json
# *
...
# *
# *  V_02 change: Get-RowSummary no longer truncates each property value to
# *  60 characters with a trailing "...". Full values are now written to the
# *  screen so long fields (e.g. RegistryPath) are never cut off. If lines
# *  wrap in a narrow console, widen the window or redirect output to a file
# *  to see the untruncated text on one line.
# ***************************************************************************
...
#   V_02: values are written out in full - no more 60-char truncation with
#   a trailing "...". Nothing here is shortened.
# ---------------------------------------------------------------------------
